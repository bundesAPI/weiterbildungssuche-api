...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.facetten  # this is an instance of the class Endpoint
        api_instance.facetten()  # this invokes api_instance.facetten.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.facetten.callable or self.callable in this class

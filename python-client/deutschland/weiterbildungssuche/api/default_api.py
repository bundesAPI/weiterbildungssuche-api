...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.facetten_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["APIKeyHeaders"],
                "endpoint_path": "/pc/v1/facetten",
                "operation_id": "facetten",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
            ...
            root_map={
                ...
                "attribute_map": {
                    ...
                    "it": "it",
                    "bg": "bg",
                    "ortsunabhaengig": "ortsunabhaengig",
                    "sort": "sort",
                },
                "location_map": {
                    "page": "query",
        ...
        self.weiterbildungssuche_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["APIKeyHeaders"],
                "endpoint_path": "/pc/v2/bildungsangebot",
    ...
    def facetten(self, **kwargs):
        """Facetten  # noqa: E501

        Facetten gibt einen Überblick über verfügbare Weiterbildungsangebote, mit der Möglichkeit nach verschiedenen GET-Parametern zu filtern.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.facetten(async_req=True)
        >>> result = thread.get()
        ...
        return self.facetten_endpoint.call_with_http_info(**kwargs)
